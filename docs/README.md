...
[![CI](https://github.com/82oberto/eventHub/actions/workflows/ci.yml/badge.svg)](https://github.com/82oberto/eventHub/actions/workflows/ci.yml)

Event ticketing platform — Spring Boot microservices, Kafka, Angular.
